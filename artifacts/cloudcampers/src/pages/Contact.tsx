            ...
            <div className="lg:col-span-2">
              <FadeIn>
                <div>
                  ...
                  <div className="p-6 rounded border border-[#E5E7EB] bg-[#FDFBF7]">
            ...
            <div className="lg:col-span-3">
              <FadeIn delay={0.15}>
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="p-8 rounded border border-[#E5E7EB] bg-white space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded bg-[#F9FAFB] border text-sm text-foreground placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/20 transition-all ${errors.name ? "border-destructive" : "border-[#E5E7EB] focus:border-[#2D6A4F]/50"}`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded bg-[#F9FAFB] border text-sm text-foreground placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/20 transition-all ${errors.email ? "border-destructive" : "border-[#E5E7EB] focus:border-[#2D6A4F]/50"}`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded bg-[#F9FAFB] border text-sm text-foreground placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/20 transition-all ${errors.company ? "border-destructive" : "border-[#E5E7EB] focus:border-[#2D6A4F]/50"}`}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 rounded bg-[#F9FAFB] border border-[#E5E7EB] text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/20 focus:border-[#2D6A4F]/50 transition-all appearance-none"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={5}
                        className={`w-full px-4 py-3 rounded bg-[#F9FAFB] border text-sm text-foreground placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/20 transition-all resize-none ${errors.message ? "border-destructive" : "border-[#E5E7EB] focus:border-[#2D6A4F]/50"}`}
                    ...
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center gap-2 px-6 py-4 text-base font-medium bg-[#2D6A4F] text-white rounded hover:bg-[#1B4332] transition-all duration-200"
                    >
                      Send Message
